...
//                                                / 0.396));
            ExSpeed_L = ExSpeed ;
            ExSpeed_R = (int)ExSpeed *(1.0+1.0*(tan((float)ServoAdd*3.14/4000)*0.396));
    } else if (ServoAdd > 200)    //左转
                {
...
//
//            ExSpeed_R =ExSpeed;
        ExSpeed_L  = (int)ExSpeed *(1.0-1.0*(tan((float)ServoAdd*3.14/4000)*0.396));
                 ExSpeed_R =ExSpeed;
