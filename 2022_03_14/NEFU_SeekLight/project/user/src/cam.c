...
uint8 GetBorder(void)
{
    ...
    {
        //扫左边线
        if (Img.LeftBorder[Ysite] < 0 + lose_error || Img.LeftBorder[Ysite] > COL - 1 - lose_error)
            Img.LeftBorderFindFlag[Ysite] = 'F', Base.LeftLoseCnt++;
        else
            Img.LeftBorderFindFlag[Ysite] = 'T';
        if(Img.LeftBorderFindFlag[Ysite] == 'T') {
            if(Base.firstleftnormal.y == ROW - 1){
                Base.firstleftnormal.y = Ysite;
                Base.firstleftnormal.x = Img.LeftBorder[Ysite];
            }
        }
        else if(Img.LeftBorderFindFlag[Ysite] == 'F'){
            if(Base.firstleftlose.y == ROW - 1) {
        ...
        if(Ysite >= 3 && Img.LeftBorderFindFlag[Ysite] == 'T' && \
            ...
            Img.LeftBorderDy[Ysite] = Img.LeftBorder[Ysite] - Img.LeftBorder[Ysite - 3];
            ...
            Img.LeftBorderDy[Ysite] = 0;
            Img.LeftSlope[Ysite] = 0.00f ;
        }
        else{
            Img.LeftBorderDy[Ysite] = NoneDy;
            Img.LeftSlope[Ysite] = NoneSlope;
        }
        //扫右边线
        if (Img.RightBorder[Ysite] < 0 + lose_error || Img.RightBorder[Ysite] > COL - 1 - lose_error)
            Img.RightBorderFindFlag[Ysite] = 'F', Base.RightLoseCnt++;
        else
            Img.RightBorderFindFlag[Ysite] = 'T';
        if(Img.RightBorderFindFlag[Ysite] == 'T') {
            if(Base.firstrightnormal.y == ROW - 1){
                Base.firstrightnormal.y = Ysite;
                Base.firstrightnormal.x = Img.RightBorder[Ysite];
            }
        }
        else if(Img.RightBorderFindFlag[Ysite] == 'F'){
            if(Base.firstrightlose.y == ROW - 1){
        ...
        if(Ysite >= 3 && Img.RightBorderFindFlag[Ysite] == 'T' && \
            ...
            Img.RightBorderDy[Ysite] = Img.RightBorder[Ysite-3] - Img.RightBorder[Ysite];
            ...
            Img.RightBorderDy[Ysite] = 0;
            Img.RightSlope[Ysite] = 0.00f ;
        }
        else{
            Img.RightBorderDy[Ysite] = NoneDy;
...
//        if (Img.LeftBorder[Ysite] == 0 && Img.RightBorder[Ysite] == COL - 1 && .
//                (ImageUsed[Ysite][COL - 1] != WhitePoint || ImageUsed[Ysite][0] != WhitePoint) && .
//                !(ImageUsed[Ysite][COL - 1] == WhitePoint && ImageUsed[Ysite][0] == WhitePoint) && .
//                Base.LoseRoadLine == ROW - 1)
          ...
          //  Img.LeftBorderFindFlag[Ysite]='T',Img.RightBorderFindFlag[Ysite]='T';
            ...
            if (((Img.RightBorderFindFlag[Ysite] == 'T'
                ...
                && (Img.RightBorder[Ysite] - Img.LeftBorder[Ysite]
                    >= RoadWide0 * 2)&&(Img.LeftBorder[Ysite]<COL/4&&Img.RightBorder[Ysite]>COL/4*3)) {
                Img.LeftBorderFindFlag[Ysite] = 'F';
                Img.RightBorderFindFlag[Ysite] = 'F';
            }
            //此处应对有丢边界的中线进行处理
