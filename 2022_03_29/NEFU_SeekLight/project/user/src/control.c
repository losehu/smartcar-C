...
int16 fork_speed=220;
uint16_t Ackerman_kl = 170;    //左右差速系数200
uint16_t Ackerman_kr = 180;//180
int16 ExSpeed_L = 0;
int16 ExSpeed_R = 0;
...
//    MotorWrite();
    ...
    if(( abs(Wheel_L.SpeedNow)>=450|| abs(Wheel_R.SpeedNow)>=450)&&!stop_flag) {
    high_speed_cnt++;
