...
int16 ExSpeed = 350; //320 NormalSpeed
int16 ExSpeed_SUM = 350; //250
int16 ExSpeed_SUM_tmp=350;
...
//                                                / 0.396));
            ExSpeed_L = ExSpeed ;
            ExSpeed_R = (int)ExSpeed *(1.0+1.0*(tan((float)ServoAdd*3.14/3800)*0.396));
...
//
//            ExSpeed_R =ExSpeed;
        ExSpeed_L  = (int)ExSpeed *(1.0-1.0*(tan((float)ServoAdd*3.14/3800)*0.396));
                 ExSpeed_R =ExSpeed;
