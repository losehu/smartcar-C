...
{
    /*   Kp       Ki       Kd     MaxO    MinO */
        {  1.2f, 0.3f , 0.000f ,999.0f  ,-999.0f},//0.120f , 0.150f , 1.600f , 0400.0f , -0400.0f //3.000f , 5.000f , 15.000f
...
{//1.4  6 0 2
    ...
    { 2.6f ,2.0f , 0.0000f ,0007.8f ,   SERVO_ADDMAX , -SERVO_ADDMAX  }, //2.0 10.0
//        { 1.5f ,2.0f , 0.0000f ,0006.9f ,   SERVO_ADDMAX , -SERVO_ADDMAX  }, //2.0 10.0
//           { 2.0f ,0.0f , 0.0000f ,0004.5f ,   SERVO_ADDMAX , -SERVO_ADDMAX  }, //2.0 10.0
