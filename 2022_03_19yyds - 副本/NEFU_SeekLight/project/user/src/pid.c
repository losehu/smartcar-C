...
{
    /*   Kp       Ki       Kd     MaxO    MinO */
        {  3.0f , 2.0f , 1.600f ,700.0f  ,-700.0f},//0.120f , 0.150f , 1.600f , 0400.0f , -0400.0f //3.000f , 5.000f , 15.000f
...
{  //
    /*    Kp1 0.65      Kp2         Ki         Kd            MaxO            MinO  4.0 1.5*/
    {  2.4f , 1.0f , 0.0000f ,0000000010.0f ,   SERVO_ADDMAX , -SERVO_ADDMAX  },
