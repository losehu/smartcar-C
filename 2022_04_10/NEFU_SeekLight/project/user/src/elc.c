...
//        {//在头文件L1-L4中调整顺序
//            ELC[i][j][3] = adc_convert(ADC_IN2,ADC_12BIT);
//            ELC[i][j][2] = adc_convert(ADC_IN1,ADC_12BIT);
//            ELC[i][j][1] = adc_convert(ADC_IN4,ADC_12BIT);
//            ELC[i][j][0] = adc_convert(ADC_IN3,ADC_12BIT);
//        }
//    }
//    //选择排序
//    //四路ADC
...
//    if(LNor[L3]<=5&&LNor[L2]<=5&&stop_flag==0)
//    {
//        ExSpeed = 0;
//                 ips114_clear(GREEN);
//             stop_flag = 1;
