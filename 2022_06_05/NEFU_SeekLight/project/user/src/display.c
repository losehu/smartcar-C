...
int ICM20602_Show()
{
    while(KeyLast != onepress)
    {
            ...
            int cntt = 239;
            float   setted_angle=0;
           float  max_angle = setted_angle -180, min_angle = setted_angle + 180;

            ips114_clear(WHITE);
            bool start_draw = true;
            while (KeyUp != onepress)
            {
                if (KeyDown == onepress)
                {
                    KeyDown = nopress;
                ...
                ips114_show_float(0, 5, Attitude_Angel_P, 3, 2);
                                ips114_show_float(0, 6, Attitude_Angel_R, 2, 3);
                                ips114_show_float(0, 7, Attitude_Angel_Y, 2, 3);

                                ips114_show_float(120, 5, ICM_State.accdata.x, 3, 2);
                                                              ips114_show_float(120, 6, ICM_State.accdata.y, 2, 3);
                                                              ips114_show_float(120, 7, ICM_State.accdata.z, 2, 3);

                                                              ips114_show_float(0, 0, ICM_State.gyro.x, 3, 2);
                                                                                                                    ips114_show_float(0, 1, ICM_State.gyro.y, 2, 3);
                                                                                                                    ips114_show_float(0, 2, ICM_State.gyro.z, 2, 3);
