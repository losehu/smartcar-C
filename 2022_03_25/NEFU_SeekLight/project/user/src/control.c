...
int16 ExSpeed = 300; //320 NormalSpeed
int16 ExSpeed_SUM = 300; //250
int16 ExSpeed_SUM_tmp=300;
int16 circle_speed = 300 ; //240
int16 fork_speed=270;
uint16_t Ackerman_kl = 120;    //左右差速系数
uint16_t Ackerman_kr = 120;
int16 ExSpeed_L = 0;
int16 ExSpeed_R = 0;
...
//ips114_show_float(0, 0,(double) pow_diff(0), 4, 3);
  // ips114_show_float(1, 1, (double)pow_diff(1), 4, 3);
