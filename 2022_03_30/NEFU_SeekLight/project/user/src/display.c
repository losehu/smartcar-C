...
void ShowRepairLine(void)
{
    //显示修复后的中线和边线
      ...
      {
          ImageWritePoint(Img.LeftBorder_Repair[Ysite] - 1,Ysite,BLUE);
          ImageWritePoint(Img.LeftBorder_Repair[Ysite]    ,Ysite,BLUE);
          ImageWritePoint(Img.LeftBorder_Repair[Ysite] + 1,Ysite,BLUE);
          ImageWritePoint(Img.RightBorder_Repair[Ysite] - 1,Ysite,BLUE);
          ImageWritePoint(Img.RightBorder_Repair[Ysite]    ,Ysite,BLUE);
          ImageWritePoint(Img.RightBorder_Repair[Ysite] + 1,Ysite,BLUE);
          ImageWritePoint(Img.Center_Repair[Ysite],Ysite,RED);
          ImageWritePoint(Img.Center_Repair[Ysite] - 1,Ysite,RED);
          ImageWritePoint(Img.Center_Repair[Ysite] + 1,Ysite,RED);
      }
}
//三岔路口元素显示
...
//        }
        ...
        ips114_show_string(150,0,(const char*)("Threshold:"));
        ips114_show_int16(150,1,ThresholdAdd);
    }
    KeyLast = nopress;
    return 0;
}
...
uint8 CamProcessing(void)
{
    while(KeyLast != onepress)
    {
      ...
      //        ImageShowX(Base.firstleftlose.x, Base.firstleftlose.y, BLUE, 10);
      //        ImageShowX(Base.firstrightlose.x, Base.firstrightlose.y, RED, 10);

              ips114_show_string(140,0,(const char*)("Cen"));
              ips114_show_int32(170,0,point_center,3);
              ips114_show_string(140,1,(const char*)("ToL"));
              ips114_show_uint8(170,1,Base.Topline);
              ips114_show_string(140,2,(const char*)("SeA"));
              ips114_show_int32(170,2,ServoAdd,3);
              //第三行显示当前元素及状态
              ips114_show_uint8(140, 4, Base.LoseRoadLine);
              ips114_show_uint8(170, 4, Base.Topline);
              ips114_show_uint8(140, 5, Base.LeftLoseCnt);
              ips114_show_uint8(170, 5, Base.RightLoseCnt);
      //        ips114_show_int8(150, 6, Cross.LD_UpAbnormalCnt);
      //        ips114_show_int8(195, 6, Cross.RD_UpAbnormalCnt);
      //        ips114_show_int8(150, 7, Cross.LU_UpNormalCnt);
      //        ips114_show_int8(195, 7, Cross.RU_UpNormalCnt);

      //        ips114_show_int8(150, 6, Barn.state);
