...
{
    /*   Kp       Ki       Kd     MaxO    MinO */
        {  1.5f , 0.5f , 0.000f ,999.0f  ,-999.0f},//0.120f , 0.150f , 1.600f , 0400.0f , -0400.0f //3.000f , 5.000f , 15.000f
        {  2.000f , 0.600f , 0.100f , 400.0f  ,-400.0f},
};
...
{//1.4  6 0 2
        //    { 2.5f ,2.0f , 0.0000f ,0007.5f ,   SERVO_ADDMAX , -SERVO_ADDMAX  }, //2.0 10.0

    /*    Kp1      Kp2         Ki         Kd            MaxO            MinO  */
    { 2.2f ,2.0f , 0.0000f ,0007.5f ,   SERVO_ADDMAX , -SERVO_ADDMAX  }, //2.0 10.0
    //    {  4.0f , 1.5f , 0.0000f ,1.0f ,   SERVO_ADDMAX , -SERVO_ADDMAX  },
  //  {  3.5f , 1.5f , 0.0000f ,1.0f ,   SERVO_ADDMAX , -SERVO_ADDMAX  },
...
float TurnPIDParam[][9] =
{
    ...
    {  4.00000f , 4.50000f , 0.04000f , 0.00000f , 090.00000f ,   0100.0f ,   -0100.0f  , 1000.0f , -1000.0f },
//                 Kp2 5.00                         Kd 40
