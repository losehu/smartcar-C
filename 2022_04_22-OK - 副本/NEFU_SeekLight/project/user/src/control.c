...
//                                    / 0.396));
            ...
            ExSpeed_R = (int)ExSpeed *(1.0+1.0*(tan((float)ServoAdd*3.14/4200)*0.396));

    } else if (ServoAdd > 100)    //左转
                {
...
//            ExSpeed_R =ExSpeed;
        ...
        ExSpeed_L  = (int)ExSpeed *(1.0-1.0*(tan((float)ServoAdd*3.14/4200)*0.396));
                 ExSpeed_R =ExSpeed;
