...
int16 ExSpeed = 330; //320 NormalSpeed
int16 ExSpeed_SUM = 330; //250
int16 ExSpeed_SUM_tmp=330;
int16 circle_speed = 330 ; //240
int16 fork_speed=330;
...
//        if(Wheel.SpeedNow<(SpeedOut_L+SpeedOut_R)/2-60)
//        {
//
//            SpeedOut_L=999;
//            SpeedOut_R=999;
