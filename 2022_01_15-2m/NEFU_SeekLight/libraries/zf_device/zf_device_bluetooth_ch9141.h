...
#define BLUETOOTH_CH9141_TX_PIN             UART2_RX_D6                                 // 蓝牙模块 1 对应模块的 TX 要接到单片机的 RX
#define BLUETOOTH_CH9141_RX_PIN             UART2_TX_D5                                 // 蓝牙模块 1 对应模块的 RX 要接到单片机的 TX
#define BLUETOOTH_CH9141_RTS_PIN            E10                                         // 蓝牙模块 1 对应模块的 RTS 引脚
