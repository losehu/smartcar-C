...
typedef struct {
    ...
    int fork_step[600][2],fork_step_cnt ;
    int cal_len ;
    int room_cnt ;
    int point1_start , point2_start , point3_start , point_len ;
    int point1_end , point2_end , point3_end ;
    int point1[10][2], point2[10][2], point3[10][3], point1_cnt , point2_cnt , point3_cnt ;
    int point2_tmp,point1_tmp,point3_tmp;
    int x_left,x_right;
} fork_fix_flag;
extern fork_fix_flag fork_fix;
