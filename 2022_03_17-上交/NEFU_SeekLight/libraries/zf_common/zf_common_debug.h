...
#define DEBUG_UART_INDEX            UART_6              //DEBUG串口
#define DEBUG_UART_BAUDRATE         2304000              //DEBUG串口波特率
#define DEBUG_UART_TX_PIN           UART6_TX_C0        //DEBUG串口TX引脚
#define DEBUG_UART_RX_PIN           UART6_RX_C1        //DEBUG串口RX引脚
