...
{
    //横线
    ImageDrawYLine(15,PINK,1);
    ImageDrawYLine(30,PINK,1);
    ImageDrawYLine(45,PINK,1);
    ImageDrawYLine(60,PINK,1);
    ImageDrawYLine(75,PINK,1);
    ImageDrawYLine(90,PINK,1);
    //竖线
    ...
    //X
    ips114_pencolor = BLUE;
    ips114_show_string(6,7,(const char*)("14"));
    ips114_pencolor = RED;
    //ips114_show_uint8(10,7,COL/2-RoadWide0/2);
    ips114_show_string(26,7,(const char*)("34"));
    ips114_pencolor = BLUE;
    ips114_show_string(49,7,(const char*)("57"));
    ips114_pencolor = RED;
    //ips114_show_uint8(88,7,COL/2+RoadWide0/2);
    ips114_show_string(72,7,(const char*)("80"));
    ips114_pencolor = BLUE;
    ips114_show_string(92,7,(const char*)("100"));
    //X
