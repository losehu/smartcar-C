...
{
    /*   Kp       Ki       Kd     MaxO    MinO */
        {  3.00f , 3.50f , 1.600f , 0500.0f  },//0.120f , 0.150f , 1.600f , 0400.0f , -0400.0f //3.000f , 5.000f , 15.000f
        {  2.000f , 0.600f , 0.100f , 0400.0f  },
};
...
{  //
    /*    Kp1 0.65      Kp2         Ki         Kd            MaxO            MinO 4.2 0.7*/
    {  4.0f , 1.5f , 0.0000f , 000.3f ,   SERVO_ADDMAX , -SERVO_ADDMAX  },
