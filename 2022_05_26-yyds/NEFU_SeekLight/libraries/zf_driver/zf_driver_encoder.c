...
static uint8_t encoder_dir_pin[TIM10_ENCOEDER + 1] = { 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF};
...
{
                                                          // 方向引脚低电平
            return myabs(((TIM_TypeDef*)tim_index[encoder_n])->CNT);                              // 返回负数值
