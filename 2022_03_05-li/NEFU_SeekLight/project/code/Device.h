...
void LEDTest(void);
void RGBTest(void);
void RGBSet_Int(void);
#define RGBBlack   0x0//0B000
#define RGBRed     0x4//0B100
#define RGBGreen   0x2//0B010
#define RGBBlue    0x1//0B001
#define RGBYellow  0x6//0B110
#define RGBPurple  0x5//0B101
#define RGBCyan    0x3//0B011
#define RGBWhite   0x7//0B111
#define RGB(x)  {                                                  \
    gpio_set_level(LEDR_PIN, ((RGBRed & limit_ab(x, 0, 7))>>2));   \
    gpio_set_level(LEDG_PIN, ((RGBGreen & limit_ab(x, 0, 7))>>1)); \
    gpio_set_level(LEDB_PIN, (RGBBlue & limit_ab(x, 0, 7)));   }
...
//SERVO
#define SERVO_MID           8850    //50Hz:8000-8850-9700/100000
#define SERVO_ADDMAX        850
