...
#define WRIELESS_UART_INDEX        UART_8                                   // 无线串口 1 对应使用的串口号
#define WRIELESS_UART_BUAD_RATE    115200                                      // 无线串口 1 对应使用的串口波特率
#define WRIELESS_UART_TX_PIN       UART8_RX_E15                                 // 无线串口 1 对应模块的 TX 要接到单片机的 RX
#define WRIELESS_UART_RX_PIN       UART8_TX_E14                                 // 无线串口 1 对应模块的 RX 要接到单片机的 TX
#define WRIELESS_UART_RTS_PIN      E2                                         // 无线串口 1 对应模块的 RTS 引脚
