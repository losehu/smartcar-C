...
int16 ExSpeed = 280; //320 NormalSpeed
int16 ExSpeed_SUM = 280; //250
int16 ExSpeed_SUM_tmp=280;
int16 circle_speed = 280 ; //240
int16 fork_speed=250;
uint16_t Ackerman_kl = 140;    //左右差速系数
uint16_t Ackerman_kr = 130;
int16 ExSpeed_L = 0;
int16 ExSpeed_R = 0;
