...
void EncoderRead(void)
{
    ...
    if((abs(Encoder_L_Cnt)>=30000||abs(Encoder_R_Cnt)>=30000)&&!stop_flag)
    {
        ips114_clear(RED);
        ips114_show_string(0, 0, "data out!!!");
        stop_flag=1;
        ExSpeed_SUM=0;
        ExSpeed=0;
    }
...
//        ips114_show_int32(120,6,EncoderAll_Cnt,5);
        ips114_pencolor = RED;
//        ips114_show_string(0, 7, "L");

   //     ips114_show_string(0, 8, "R");
//        ips114_show_int8(120, 7, gpio_get_level(encoder_dir_pin[ENCODER_L_TIM]));
//
//        ips114_show_int8(120, 8, gpio_get_level(encoder_dir_pin[ENCODER_R_TIM]));
