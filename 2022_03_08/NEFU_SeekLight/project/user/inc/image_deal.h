...
#define  ImageUsed     SimBinImage//CamImage//定义用于透视变换的图像
#define PER_IMG   *PerImg_ip//*PerImg_ip//SimBinImage//定义使用的图像，ImageUsed为用于巡线和识别的图像，在cam.c中使用

//param
//extern uint8_t CamImage[USED_ROW][USED_COL];//总钻风获取的灰度图像，由ImageBuffer()获取或者宏定义
extern uint8_t SimBinImage[ROW][COL]; //简易无逆透视二值化图像，由GetSimBinImage()获取
