...
//                                                / 0.396));
            ExSpeed_L = ExSpeed ;
            ExSpeed_R = (int)ExSpeed *(1.0+1.0*(tan((float)ServoAdd*3.14/diff_speed)*0.396));
    } else if (ServoAdd > 20)    //左转
                {
...
//
//            ExSpeed_R =ExSpeed;
        ExSpeed_L  = (int)ExSpeed *(1.0-1.0*(tan((float)ServoAdd*3.14/diff_speed)*0.396));
                 ExSpeed_R =ExSpeed;
...
//if(Wheel_R.SpeedNow>ExSpeed_R+50)SpeedOut_R=-999;
//if(Wheel_L.SpeedNow>ExSpeed_L+50)SpeedOut_L=-999;
